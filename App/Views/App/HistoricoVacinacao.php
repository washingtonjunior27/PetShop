<div class="container">
    ...
    <div class="container p-0 my-4">
        ...
        <div class="bg-white shadow-lg px-3 pt-3 rounded mt-3">
            <h2 class="fs-4 fw-bold ">Listagem de Históricos de Vacinação</h2>
            ...
            <div class="table-responsive mt-4">
                <table class="table table-striped-columns align-middle text-nowrap">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <a class="text-decoration-none" href="<?= BASE_URL ?>/historicoVacinacao/VisualizarHistoricoVacinacao">
